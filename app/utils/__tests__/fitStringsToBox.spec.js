...
import { BASE_FONT_SIZE_PX, MIN_FONT_SIZE_PX, MIN_LINE_HEIGHT, MAX_LINE_HEIGHT, } from "../../constants";
describe("fitStringsToBox", () => {
    ...
    describe("font size constraints", () => {
        ...
        it("should reduce font size for longer strings", () => {
            ...
            const longResult = fitStringsToBox(["This is a much much longer string that takes more space"], 5, 5);
        ...
        it("should reduce font size for more strings", () => {
            ...
            const manyResult = fitStringsToBox(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"], 10, 10);
    ...
    describe("box dimension handling", () => {
        ...
        it("should respect height constraint", () => {
            ...
            const shortResult = fitStringsToBox(["A", "B", "C", "D", "E"], 10, 3);
            const tallResult = fitStringsToBox(["A", "B", "C", "D", "E"], 10, 15);
