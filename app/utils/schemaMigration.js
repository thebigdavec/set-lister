 ...
 */
function hasStoreStateStructure(data) {
    ...
    if (!state.sets.every(isValidSet))
        return false;
 ...
 */
export function migrateToCurrentSchema(data) {
