import { BASE_FONT_SIZE_PX, CM_TO_PX, DEFAULT_FONT_FAMILY, MAX_LINE_HEIGHT, MIN_FONT_SIZE_PX, MIN_LINE_HEIGHT, } from "../constants";
import { formatSongLabel } from "./textMetrics";
// Cached DOM element for text measurement
let cachedMeasureSpan = null;
/**
 ...
 */
export function fitStringsToBox(strings, boxWidthCm, boxHeightCm) {
    ...
    const maxFontByHeight = boxHeightPx / (lineHeightRatio * MIN_LINE_HEIGHT * numLines);
    ...
    const standardTextHeightPx = fontSizePx * lineHeightRatio * MIN_LINE_HEIGHT * numLines;
